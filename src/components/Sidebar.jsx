...
import { updateSelected , getSelectCategory } from "../features/videos/videoSlice";
  ...
  return (
    ...
    >
      {categories.map((category) => (
        <button className="category-btn" style={{backgroundColor: category.name===selectedCategory && '#FC1503' , color:'white'}}
        key={category.name}
